...
INSERT INTO categories (category_id, parent_id, category_name, category_name_uz, category_name_ru, description, description_uz, description_ru, image_url) VALUES ('34d7f2b8-9c6a-4f4b-a5d8-2e7b6a9d3c1f', 'a27c8ffe-8d08-4578-bd7c-de336f4ff8d1', 'Kids'' Clothes','Bolalar kiyimlari', 'Детская одежда','T-Shirts, Pants, Dresses, Jackets', 'Futbolkalar, shimlar, ko‘ylaklar, kurtkalar','Футболки, брюки, платья, куртки','https://listin-app-images.s3.eu-north-1.amazonaws.com/clothes.png');
