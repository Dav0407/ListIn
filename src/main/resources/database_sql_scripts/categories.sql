...
-- Child category "Cars"
INSERT INTO categories (category_id, parent_id, category_name, category_name_uz, category_name_ru, description, description_uz, description_ru, image_url) VALUES ('36e2c837-320a-4ac0-9aa5-e37d0be1889f', '5d211862-168e-41ad-af27-a9ad461169f6', 'Cars', 'Avtomobillar', 'Легковые автомобили', 'Sedans, SUVs, Hatchbacks...', 'Sedanlar, SUVlar, Xetchbeklar...', 'Седаны, внедорожники, хэтчбеки...','https://listin-app-images.s3.eu-north-1.amazonaws.com/cars_car-min.png');

-- Child category Motorcycles
INSERT INTO categories (category_id, parent_id, category_name, category_name_uz, category_name_ru, description, description_uz, description_ru, image_url) VALUES ('c0011135-e8ff-4c1e-aab5-6c6a47451ab4', '5d211862-168e-41ad-af27-a9ad461169f6', 'Motorcycles', 'Mototsikllar', 'Мотоциклы', 'Sport Bikes, Cruisers, Dirt Bikes...', 'Sport velosipedlari, kreyserlar, yoʻl tanlamas velosipedlar...', 'Спортивные велосипеды, круизеры, мотоциклы для бездорожья...','https://listin-app-images.s3.eu-north-1.amazonaws.com/cars_motorcycles-min.png');

-- Child category Commercial Vehicles
INSERT INTO categories (category_id, parent_id, category_name, category_name_uz, category_name_ru, description, description_uz, description_ru, image_url) VALUES ('071bb3ee-850e-463d-a140-1ea2f8b0e4fa', '5d211862-168e-41ad-af27-a9ad461169f6', 'Commercial Vehicles', 'Tijorat transport vositalari', 'Коммерческий транспорт', 'Trucks, vans, buses...', 'Yuk mashinalari, furgonlar, avtobuslar...', 'Грузовики, фургоны, автобусы...','https://listin-app-images.s3.eu-north-1.amazonaws.com/cars_commercial-min.png');
