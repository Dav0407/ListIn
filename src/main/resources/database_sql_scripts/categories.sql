...
INSERT INTO categories (category_id, parent_id, category_name, description, image_url) VALUES ('e51e9a61-8f59-4390-adf4-4142f6b28645', '050747ed-c6aa-409c-835c-e7cd30bc4d98', 'Macbooks', 'Macbook Air M1, Macbook Pro M1...','https://listin-app-images.s3.eu-north-1.amazonaws.com/macbook.png');
...
INSERT INTO categories (category_id, parent_id, category_name, description, image_url) VALUES ('b41e5ed9-1909-4fcb-85ca-0d209c110c5c', '050747ed-c6aa-409c-835c-e7cd30bc4d98', 'Smartwatches', 'Apple, Samsung, Huawei...','https://listin-app-images.s3.eu-north-1.amazonaws.com/watches.png');
...
INSERT INTO categories (category_id, parent_id, category_name, description, image_url) VALUES ('d9d0a1d3-418d-4b28-8e1d-b5fc7edc8cf2', '050747ed-c6aa-409c-835c-e7cd30bc4d98', 'Personal Computers', 'Gaming PC, Mini PC, Desktop PC...','https://listin-app-images.s3.eu-north-1.amazonaws.com/gaming.png');
...
INSERT INTO categories (category_id, parent_id, category_name, description, image_url) VALUES ('3e53ed81-131f-454c-91d1-f62a9f859158', '050747ed-c6aa-409c-835c-e7cd30bc4d98', 'Televisions', 'Smart TV, LED TV, OLED TV...','https://listin-app-images.s3.eu-north-1.amazonaws.com/tv.png');
...
INSERT INTO categories (category_id, parent_id, category_name, description, image_url) VALUES ('85a7d948-ed9c-4199-a9bf-51feb805e9d9', '050747ed-c6aa-409c-835c-e7cd30bc4d98', 'Gaming Consoles', 'PlayStation, Xbox, Nintendo...','https://listin-app-images.s3.eu-north-1.amazonaws.com/console.png');

-- Child category "Audio Equipment"
INSERT INTO categories (category_id, parent_id, category_name, description, image_url) VALUES ('4bbffb60-4832-4f24-bf74-343c2678b46e', '050747ed-c6aa-409c-835c-e7cd30bc4d98', 'Audio Equipment', 'Headphones, Speakers, Earbuds...','https://listin-app-images.s3.eu-north-1.amazonaws.com/audio.png');
