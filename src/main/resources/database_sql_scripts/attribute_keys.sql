...
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('b2635cd6-4100-4eea-9e7f-9d010166d7f2','string','Select Processor Brands', 'Select Processor', 'oneSelectable', 'oneSelectable', 'Laptop Processor Brands');
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('5be6a6e1-4499-442c-886a-c439fec6e9a4','string','Select GPU Brands', 'Select GPU', 'oneSelectable', 'oneSelectable', 'Laptop GPU Brands');
...
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('cc85b860-f078-41a3-a1f6-d2d7c35b3448','string','Select Battery Capacity', 'oneSelectable', 'null', 'null', 'Macbook Battery Capacity');
...
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('059fc660-4d24-43c2-8d98-a0848e6ac7b3','string','Select Processor Brand', 'Select Processor', 'oneSelectable', 'oneSelectable', 'PC Processor Brand');
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('dd2769d4-c6a0-40c6-af4b-819d04129c12','string','Select GPU Brand', 'Select GPU', 'oneSelectable', 'oneSelectable', 'PC GPU Brands');
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('cef16c16-812d-4572-b80b-292cbf8d7d0c','string','Select SSD Storage', 'null', 'oneSelectable', 'null', 'PC SSD Storage');
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('5b50c211-94fc-4db2-b16c-9d40d1801643','string','Select HDD Storage', 'null', 'oneSelectable', 'null', 'PC HDD Storage');
