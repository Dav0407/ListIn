...
INSERT INTO attribute_keys (attribute_id, data_type, helper_text, sub_helper_text, widget_type, sub_widget_type, name) VALUES ('5be6a6e1-4499-442c-886a-c439fec6e9a4','string','Select GPU', 'Select Gpu', 'oneSelectable', 'oneSelectable', 'Laptop Gpu Brands');
